...
// Caso de referência: RR=15 cpm, VT=450 mL, Ppico=25, Pplat=20, PEEP=8
// DP = 20 - 8 = 12; Ppico - 0.5*DP = 25 - 6 = 19; VT em L = 0.45
...
// Caso de alto risco: RR=25 cpm, VT=500 mL, Ppico=35, Pplat=28, PEEP=10
// DP = 18; Ppico - 0.5*DP = 35 - 9 = 26; VT em L = 0.5
...
// Caso de baixo esforço: RR=10 cpm, VT=350 mL, Ppico=15, Pplat=13, PEEP=6
// DP = 7; Ppico - 0.5*DP = 15 - 3.5 = 11.5; VT em L = 0.35
